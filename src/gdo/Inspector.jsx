...
export default function Inspector({ place, onClose }) {
  ...
  return (
    <motion.div
      ...
      className="gdo-inspector absolute z-30 top-0 bottom-4 left-0 right-auto xl:left-auto xl:right-6 md:z-20 w-[340px] xl:w-[360px] xl:top-6 xl:bottom-8 pointer-events-auto"
    >
      <Button
